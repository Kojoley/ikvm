...
namespace IKVM.Compiler
{
    ...
    public abstract class JavaClassContext
    {
        ...
        readonly ConcurrentDictionary<JavaClassName, JavaClassHandle> classes = new();
        ...
        /// <returns></returns>
        public JavaClassHandle Resolve(JavaClassName className) => classes.GetOrAdd(className, ResolveCore);
        ...
        /// <param name="className"></param>
        /// <returns></returns>
        protected abstract JavaClassHandle ResolveCore(JavaClassName className);
